...
const Gallery = () => {
  ...
  const images = [
    ...
    {
      id: 6,
      src: "https://images.unsplash.com/photo-1590490360182-c33d57733427?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80",
      alt: "Rooftop Pool",
      category: "Amenities"
    },
    {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Take a visual journey through our magnificent spaces, where every corner 
            tells a story of elegance and sophisticated design.
          </p>
        </motion.div>
